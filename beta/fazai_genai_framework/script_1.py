# Criando o arquivo de configuração do framework
framework_config_content = '''"""
...
with open('framework_config.py', 'w') as f:
    f.write(framework_config_content)

print("✅ Arquivo framework_config.py criado com sucesso!")