# Criando script de importação de diálogos Claude
import_claude_script = '''#!/usr/bin/env python3
...
with open('import_claude.py', 'w') as f:
    f.write(import_claude_script)

# Tornar executável
os.chmod('import_claude.py', 0o755)

print("✅ Script import_claude.py criado com sucesso!")