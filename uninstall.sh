...
if [ "$PRESERVE_CONFIG" = true ]; then
    ...
    # Backup das ferramentas específicas (v2.0.0)
    TOOLS_TO_BACKUP=(
...
# Remove outros links simbólicos relacionados (v2.0.0)
LINKS_TO_REMOVE=(
    "fazai-config"
    "fazai-backup"
    "fazai-uninstall"
...
# Remove ferramentas específicas (v2.0.0)
...
# Limpeza de processos órfãos (v2.0.0)
...
# Limpeza de arquivos temporários (v2.0.0)
