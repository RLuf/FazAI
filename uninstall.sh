...
# Versão: 1.41.0 - Atualizado para limpeza completa e reinstalação
...
if [ "$PRESERVE_CONFIG" = true ]; then
    ...
    # Backup das ferramentas específicas (v1.41.0)
    TOOLS_TO_BACKUP=(
...
# Remove outros links simbólicos relacionados (v1.41.0)
LINKS_TO_REMOVE=(
    "fazai-config"
    "fazai-backup"
    "fazai-uninstall"
...
# Remove ferramentas específicas (v1.41.0)
...
# Limpeza de processos órfãos (v1.41.0)
...
# Limpeza de arquivos temporários (v1.41.0)
...
echo -e "${PURPLE}[INFO]${NC} Limpeza específica da versão 1.41.0 concluída:"
